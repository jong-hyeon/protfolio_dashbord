...
export function AssetForm({ onSubmit }: AssetFormProps) {
  ...
  return <Card><CardHeader><CardTitle>자산 추가</CardTitle><CardDescription>수량과 현재가를 입력하면 평가금액을 계산합니다.</CardDescription></CardHeader><CardContent><form className="grid gap-4 md:grid-cols-2" onSubmit={handleSubmit}>
