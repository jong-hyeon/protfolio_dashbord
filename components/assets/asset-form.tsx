...
export function AssetForm({ onSubmit }: AssetFormProps) {
  ...
  return <Card><CardHeader className="p-5 pb-4 sm:p-6 sm:pb-4"><CardTitle className="text-xl">자산 추가</CardTitle><CardDescription>수량과 현재가를 입력하면 평가금액을 계산합니다.</CardDescription></CardHeader><CardContent className="p-5 pt-0 sm:p-6 sm:pt-0"><form autoComplete="off" className="grid gap-5 md:grid-cols-2" onSubmit={handleSubmit}>
